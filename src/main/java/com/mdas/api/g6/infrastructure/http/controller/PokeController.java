package com.mdas.api.g6.infrastructure.http.controller;
...
public class PokeController {
    ...
    private final GetApiPokemonTypesByName getApiPokemonTypesByName;

    @GetMapping(value = "/getType")
    public ResponseEntity<?> getPokemon(@RequestParam(value = "pokemonName") String pokemonName) {
        try {
            return ResponseEntity.ok(getApiPokemonTypesByName.getPokemonType(pokemonName).getBody());
